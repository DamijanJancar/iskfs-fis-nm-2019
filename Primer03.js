...
http.createServer(function(req, res){ // http.createServer([requestListener])
    ...
    if (operator1 == 4) {
        console.log("Vključevanje obeh LED-ic");
        board.digitalWrite(8, board.HIGH);
        board.digitalWrite(13, board.HIGH);
    } 
    if (operator1 == 5) {
        console.log("Izključevanje obeh LED-ic");
        board.digitalWrite(8, board.LOW);
        board.digitalWrite(13, board.LOW);
    } 
    ...
    res.write("Za test vpišite v brskalnikovo vrstico z naslovom: http://192.168.1.207:8080/1/1 <br>");
    res.write("ali: http://192.168.1.207:8080/0/0<br>");
    res.end("Vrednost operatorja1: " + operator1 + "<br>" + "Vrednost operatorja2: " + operator2);
    
}).listen(8080, "192.168.1.207");
